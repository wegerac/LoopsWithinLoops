...
def run_test_sum_numbers():
    ...
    # Test 3
    exp = 4
    ans = sum_numbers(([1], [2, 1]))
    print('Expected and actual are:', exp, ans)

    # Test 4
    exp = 25
    ans = sum_numbers(([1, 2, 3, 4, 5, 6], [2, 2]))
    print('Expected and actual are:', exp, ans)

    # Test 5
    exp = 6
    ans = sum_numbers(([1], [2, 3]))
    print('Expected and actual are:', exp, ans)
